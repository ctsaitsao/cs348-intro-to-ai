...
class Statement(object):
    ...
    def included(self, object):
    	for term in self.terms:
    		if object == term.term.element:
    			return True
    	return False
...
class Term(object):
    ...
    def __init__(self, term):
        ...
        self.term = term if is_var_or_const else (Variable(term) if util.is_var(term) else Constant(term))
...
class Bindings(object):
    ...
    def bound_to(self, variable):
        ...
        if variable.element in self.bindings_dict.keys():
            ...
            if value:
                return Variable(value) if util.is_var(value) else Constant(value)
